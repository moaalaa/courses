    ...
    <body>
      ...
      <div class="container">
        ...
        <form method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>" enctype="multipart/form-data" class="formValidation">
            ...
            <input type="text" name="Instructor" placeholder="cource Instructor" class="in inputValidation form-control">
            <input type="text" name="url" class="in inputValidation form-control">
            <input type="submit" class="in btn btn-primary btn-block" name="add" value="add cources"/>	
                  
            
        </form>
        <div class="errorMessage"></div>
         <form method="post" action="onlineCourse-E-D.php">
