    ...
    <nav class="navbar navbar-inverse">
      <div class="container">
    	...
    	<div class="container body">
        	<a href="artical.php"><button class="btn btn-block btn-lg btn-primary button">Go And Add Article</button></a>
            <a href="category.php"><button class="btn btn-block btn-lg btn-primary button">Go And Add Categoury</button></a>
            <a href="onlineCourse.php"><button class="btn btn-block btn-lg btn-primary button">Go And add online course</button></a>
            <a href="course.php"><button class="btn btn-block btn-lg btn-primary button">Go And Cources</button></a>
        </div>
